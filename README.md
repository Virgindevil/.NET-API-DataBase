...
Реализует управление возвратами товаров от допустим Ozon продавцам (селлерам): создание запросов на возврат, отслеживание статусов, интеграция со складской логистикой.
